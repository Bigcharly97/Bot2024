...
const handler = async (m, {conn, command, args, text, usedPrefix}) => {
  if (!text) throw `_*< GOKU - PLAY />*_\n\n*ᴇʀʀᴏʀ ɪɴɢʀᴇsᴀ ᴇʟ ᴄᴏᴍᴀɴᴅᴏ ᴍᴀs ᴇʟ ɴᴏᴍʙʀᴇ ᴅᴇ ʟᴀ ᴄᴀɴᴄɪᴏ́ɴ.*\n\n*[ 💡 ] ᴇᴊᴇᴍᴘʟᴏ:* _${usedPrefix + command} ᴇʟ ᴀᴍᴏʀ ᴅᴇ sᴜ ᴠɪᴅᴀ ᴄᴀʀɪɴ ʟᴇᴏɴ_`;
    ...
    const texto1 = `_*< ◉ɢᴏᴋᴜ ʙᴏᴛ◉ />*_\n\n❏ *ᴛʀᴀʙᴀᴊᴀɴᴅᴏ...*  ${additionalText}. *ᴇsᴛᴏ ᴘᴜᴇᴅᴇ ᴛᴀʀᴅᴀʀ ᴇɴᴛʀᴇ 2 ᴀ 5 ᴍɪɴᴜᴛᴏs*`.trim();
